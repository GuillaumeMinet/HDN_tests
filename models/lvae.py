...
class LadderVAE(nn.Module):
    ...
    def __init__(self,
        ...
        # Optional initial upsampling step
        if self.initial_upsamp:
            self.upsamp_layer = nn.Sequential(
                nn.ConvTranspose2d(in_channels=1,out_channels=n_filters,kernel_size=4,padding=1,stride=2),
                nonlin(),
